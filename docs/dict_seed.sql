-- ============================================================================
-- 数据字典种子（独立执行版，与 Flyway V19__dict_seed.sql 内容一致）。
-- 直接在 MySQL 中执行即可；INSERT IGNORE 保证可重复运行不产生重复行。
-- 核心法规域：dict_data.dict_code 存「类型编码」，dict_value 存代码，
-- 与前端 utils/labels.ts 的 *Options.value 完全一致。全为平台公共数据（tenant_id=0）。
-- ============================================================================
SET NAMES utf8mb4;
